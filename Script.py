...
<b>• sᴇɴᴅ /tts ᴛᴏ ᴜsᴇ ᴛʜɪs ғᴇᴀᴛᴜʀᴇ</b>"""
    ...
    DISCLAIMER_TXT = """<blockquote><b>🌐 Movies/Series Search Rules 🔍</blockquote>
...
<blockquote> <b> <a href='https://t.me/+A_-yDwUbIM9jODhl'>➜ ɪғ ᴍᴏᴠɪᴇ/ꜱᴇʀɪᴇꜱ ɴᴏᴛ ғᴏᴜɴᴅ ɪɴ ᴅᴀᴛᴀʙᴀꜱᴇ ꜱᴇɴᴅ ɴᴀᴍᴇ ɪɴ Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ</a>.</b> </blockquote>"""
    ABOUT_TEXT = """<blockquote> <b> <a href='tg://settings'>𝕄𝕪 𝔻𝕖𝕒𝕣 𝔽𝕣𝕚𝕖𝕟𝕕</a></b> </blockquote>

<b>ʙᴇғᴏʀᴇ ʏᴏᴜ ꜱᴇᴀʀᴄʜ / ʀᴇǫᴜᴇꜱᴛ ᴀɴʏ ᴄᴏɴᴛᴇɴᴛ ʀᴇᴀᴅ ᴅɪꜱᴄʟᴀɪᴍᴇʀ ᴀɴᴅ ʀᴜʟᴇꜱ ‼️</b>"""
    SUPPORT_GRP_MOVIE_TEXT = """<b>Hᴇʏ 𓆩{}𓆪.

<blockquote>✥ ʏᴏᴜʀ ʀᴇǫᴜᴇꜱᴛ ɪꜱ ᴀʟʀᴇᴀᴅʏ ᴀᴠᴀɪʟᴀʙʟᴇ.. ✅

📂 ꜰɪʟᴇꜱ ꜰᴏᴜɴᴅ : {}

‼️ ᴛʜɪs ɪs ᴀ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ sᴏ ᴛʜᴀᴛ ʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ғɪʟᴇs ғʀᴏᴍ ʜᴇʀᴇ...</blockquote>

 ⇓ ꜱᴇᴀʀᴄʜ ɪɴ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ ⇓   </b>"""
...
❏ Bᴜᴛ ғᴏʀ ᴀʟʟ ᴛʜɪꜱ ᴡᴇ ʜᴀᴠᴇ ᴛᴏ
ꜱᴘᴇɴᴅ ᴏɴ ꜱᴇʀᴠᴇʀ ᴀɴᴅ ᴏᴛʜᴇʀ ᴛʜɪɴɢꜱ

❏ Iғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴋᴇᴇᴘ 
ᴘʀᴏᴠɪᴅɪɴɢ ꜱᴜᴄʜ ғʀᴇᴇ ᴏғ ᴄᴏꜱᴛ ᴄᴏɴᴛᴇɴᴛ 

❏ Tʜᴇɴ ᴘʟᴇᴀꜱᴇ ꜱᴜᴘᴘᴏʀᴛ ᴜꜱ ᴀ ʟɪᴛᴛʟᴇ. </blockquote>
Donate ➧ DevThanos.vercel.app </b>"""
